...
function getForecast(coordinates) {
  ...
  let apiUrl = `https://api.shecodes.io/weather/v1/forecast?lat=${coordinates.latitude}&lon=${coordinates.longitude}&key=80ab7od3ab75f07480betdd57ff51e6b&units=metric`;
  console.log(apiUrl);
